import { RoleAttackModel, ClassType, RoleHealthModel, MinionCardModel, RarityType, DivineShieldModel, CostModel, LibraryService } from "hearthstone-core";

@LibraryService.is('argent-squire')
