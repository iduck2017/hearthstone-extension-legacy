 ...
 */
import { GameModel, PlayerModel, HandModel, BoardModel, MageModel, AnimeUtil, ManaModel, CommonUtil } from "hearthstone-core";
...
describe('grimscale-oracle', () => {
    ...
    test('murloc-raider-attack-grimscale-oracle', async () => {
        ...
        expect(cardF.child.dispose.state.isActived).toBe(true); // Murloc Raider
