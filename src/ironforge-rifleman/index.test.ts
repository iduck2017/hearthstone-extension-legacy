...
describe('ironforge-rifleman', () => {
    ...
    const cardC = handA.refer.order.find(item => item instanceof IronforgeRiflemanModel);
    ...
    test('ironforge-rifleman-play', async () => {
        ...
        expect(handA.refer.order.length).toBe(1); // Ironforge Rifleman in hand
        ...
        expect(boardA.refer.order.length).toBe(1); // Ironforge Rifleman on board
        expect(handA.refer.order.length).toBe(0); // Ironforge Rifleman moved to board
