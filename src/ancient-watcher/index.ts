...
import { RoleAttackModel, ClassType, RoleHealthModel, MinionCardModel, RarityType, RoleModel, LibraryUtil, CostModel } from "hearthstone-core";
                ...
                child: {
                    ...
                    role: new RoleModel(() => ({
                        child: {
                            ...
                            features: [new AncientWatcherFeatureModel()]
                        }
                    })),
                    ...props.child,
                },
