...
describe('spellbreaker', () => {
    ...
    test('spellbreaker-play', async () => {
        ...
        expect(cardD.child.feats.child.divineShield).toBeDefined(); // Silvermoon Guardian has Divine Shield
        ...
        expect(cardD.child.feats.child.divineShield.state.isActive).toBe(false); // Divine Shield removed by silence
    });
