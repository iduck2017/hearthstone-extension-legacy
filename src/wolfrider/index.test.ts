...
describe('wolfrider', () => {
    ...
    const cardC = handA.refer.order.find(item => item instanceof WolfriderModel);
    ...
    test('wolfrider-play', async () => {
        ...
        expect(handA.refer.order.length).toBe(1); // Wolfrider in hand
        ...
        expect(boardA.refer.order.length).toBe(1); // Wolfrider on board
        expect(handA.refer.order.length).toBe(0); // Wolfrider moved to board
    ...
    test('wolfrider-attack', async () => {
        ...
        expect(boardA.refer.order.length).toBe(0); // Wolfrider dies
    });
});
