...
describe('river-crocolisk', () => {
    ...
    const cardC = handA.refer.order.find(item => item instanceof RiverCrocoliskModel);
    ...
    test('river-crocolisk-play', async () => {
        ...
        expect(handA.refer.order.length).toBe(1); // River Crocolisk in hand
        ...
        expect(boardA.refer.order.length).toBe(1); // River Crocolisk on board
        expect(handA.refer.order.length).toBe(0); // River Crocolisk moved to board
