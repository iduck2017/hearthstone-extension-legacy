...
describe('mogushan-warden', () => {
    ...
    const cardC = handA.refer.order.find(item => item instanceof MogushanWardenModel);
    ...
    test('mogushan-warden-play', async () => {
        ...
        expect(handA.refer.order.length).toBe(1); // Mogu'shan Warden in hand
        ...
        expect(boardA.refer.order.length).toBe(1); // Mogu'shan Warden on board
        expect(handA.refer.order.length).toBe(0); // Mogu'shan Warden moved to board
