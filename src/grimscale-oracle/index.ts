...
import { MinionCardModel, RoleHealthModel, RoleAttackModel, RoleModel, RaceType, FeatureModel, RarityType, ClassType, LibraryUtil, CostModel } from "hearthstone-core";
                ...
                child: {
                    ...
                    role: new RoleModel(() => ({
                        child: {
                            ...
                            features: [new GrimscaleOracleFeatureModel()]
                        }
                    })),
                    ...props.child,
                },
