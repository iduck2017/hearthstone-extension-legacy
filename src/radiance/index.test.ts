...
describe('radiance', () => {
    ...
    test('fireball-cast', async () => {
        ...
        expect(handA.refer.order.length).toBe(0); // Fireball consumed
    ...
    test('radiance-cast', async () => {
        ...
        expect(handB.refer.order.length).toBe(1);
        ...
        expect(handB.refer.order.length).toBe(0); // Radiance consumed
