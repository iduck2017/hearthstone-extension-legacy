...
describe('magma-rager', () => {
    ...
    const cardC = handA.refer.order.find(item => item instanceof MagmaRagerModel);
    ...
    test('magma-rager-play', async () => {
        ...
        expect(handA.refer.order.length).toBe(1); // Magma Rager in hand
        ...
        expect(boardA.refer.order.length).toBe(1); // Magma Rager on board
        expect(handA.refer.order.length).toBe(0); // Magma Rager moved to board
