...
export class ArcaneMissilesSliceEffectModel extends EffectModel<never> {
    constructor(props?: ArcaneMissilesSliceEffectModel['props']) {
        props = props ?? {};
        super({
            uuid: props.uuid,
            state: {
                name: "Arcane Missiles Slice's effect",
