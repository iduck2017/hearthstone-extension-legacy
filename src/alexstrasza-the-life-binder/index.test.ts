...
describe('alexstrasza-the-life-binder', () => {
    ...
    const cardC = handA.refer.order.find(item => item instanceof AlexstraszaTheLifeBinderModel);
    const cardD = handB.refer.order.find(item => item instanceof AlexstraszaTheLifeBinderModel);
    ...
    test('alexstrasza-the-life-binder-damage', async () => {
        ...
        expect(handA.refer.order.length).toBe(1); // Alexstrasza in hand
        ...
        expect(boardA.refer.order.length).toBe(1); // Alexstrasza on board
        expect(handA.refer.order.length).toBe(0); // Alexstrasza moved to board
    ...
    test('alexstrasza-the-life-binder-heal', async () => {
        ...
        expect(handB.refer.order.length).toBe(1); // Alexstrasza in hand
        ...
        // Alexstrasza should be on board
        expect(playerB.child.board.refer.order.length).toBe(1); // Alexstrasza on board
        expect(handB.refer.order.length).toBe(0); // Alexstrasza moved to board
