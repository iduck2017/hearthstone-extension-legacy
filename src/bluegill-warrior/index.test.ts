...
describe('bluegill-warrior', () => {
    ...
    const cardC = handA.refer.order.find(item => item instanceof BluegillWarriorModel);
    ...
    test('bluegill-warrior-play', async () => {
        ...
        expect(handA.refer.order.length).toBe(1); // Bluegill Warrior in hand
        ...
        expect(boardA.refer.order.length).toBe(1); // Bluegill Warrior on board
        expect(handA.refer.order.length).toBe(0); // Bluegill Warrior moved to board
