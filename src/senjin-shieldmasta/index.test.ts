...
describe('senjin-shieldmasta', () => {
    ...
    const cardC = handA.refer.order.find(item => item instanceof SenjinShieldmastaModel);
    ...
    test('senjin-shieldmasta-play', async () => {
        ...
        expect(handA.refer.order.length).toBe(1); // Sen'jin Shieldmasta in hand
        ...
        expect(boardA.refer.order.length).toBe(1); // Sen'jin Shieldmasta on board
        expect(handA.refer.order.length).toBe(0); // Sen'jin Shieldmasta moved to board
