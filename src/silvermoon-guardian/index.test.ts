...
describe('silvermoon-guardian', () => {
    ...
    const cardC = handA.refer.order.find(item => item instanceof SilvermoonGuardianModel);
    ...
    test('silvermoon-guardian-play', async () => {
        ...
        expect(handA.refer.order.length).toBe(1); // Silvermoon Guardian in hand
        ...
        expect(boardA.refer.order.length).toBe(1); // Silvermoon Guardian on board
        expect(handA.refer.order.length).toBe(0); // Silvermoon Guardian moved to board
