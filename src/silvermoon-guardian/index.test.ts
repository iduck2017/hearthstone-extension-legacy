...
describe('silvermoon-guardian', () => {
    ...
    test('silvermoon-guardian-play', async () => {
        ...
        expect(cardC.child.feats.child.divineShield).toBeDefined(); // Has Divine Shield
    });
    ...
    test('wisp-attack', async () => {
        ...
        expect(cardC.child.feats.child.divineShield.state.isActive).toBe(false); // Divine Shield broken
    });
});
