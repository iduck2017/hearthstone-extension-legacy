...
describe('chillwind-yeti', () => {
    ...
    const cardC = handA.refer.order.find(item => item instanceof ChillwindYetiModel);
    ...
    test('chillwind-yeti-play', async () => {
        ...
        expect(handA.refer.order.length).toBe(1); // Chillwind Yeti in hand
        ...
        expect(boardA.refer.order.length).toBe(1); // Chillwind Yeti on board
        expect(handA.refer.order.length).toBe(0); // Chillwind Yeti moved to board
