...
describe('polymorph', () => {
    ...
    test('polymorph-cast', async () => {
        ...
        const selelctor = playerA.controller.current;
        ...
        playerA.controller.set(cardD); // Target Water Elemental
        await promise;
        ...
        expect(cardF.child.attack.state.current).toBe(1); // Sheep: 1/1
        ...
        expect(cardD.route.board).toBeUndefined();
    });
});